...
public class PredictivePriceLookUpDataDriven extends TestSuiteMaster {
    ...
    public PredictivePriceLookUpDataDriven(String fromAreaID, String toAreaID) {
    ...
    public void checkAllPriceLookUpSuccess(){
        ...
        Log.info("Get predictive price lookup of whole truck");
